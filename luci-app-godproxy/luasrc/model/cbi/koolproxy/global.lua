...
if luci.sys.call("pidof koolproxy >/dev/null") == 0 then
	status = translate("<strong><font color=\"green\">KPR去广告  运行中</font></strong>")
else
	status = translate("<strong><font color=\"red\">KPR去广告  已停止</font></strong>")
end

o = Map("koolproxy", translate("KPR去广告 "), translate("KoolProxyR是基于KoolProxyR Plus重新整理的能识别adblock规则的免费开源软件,追求体验更快、更清洁的网络，屏蔽烦人的广告！"))
