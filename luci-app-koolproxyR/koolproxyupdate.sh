wget 'https://down.cmccw.xyz/kp.dat' -O files/usr/share/koolproxy/data/rules/kp.dat
wget 'https://down.cmccw.xyz/daily.txt' -O files/usr/share/koolproxy/data/rules/daily.txt
...
wget 'https://down.cmccw.xyz/user.txt' -O files/usr/share/koolproxy/data/user.txt
